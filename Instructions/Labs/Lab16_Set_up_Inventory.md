---
lab:
  title: 'Lab 16: Set up Inventory'
  module: 'Get started with warehouse management in Dynamics 365 Business Central'
  duration: 60 minutes
  level: 300
  islab: true
---

## Exercise 16: Set up Inventory
...
1. Set up and assign number series.
   ...
   3. In the **Item Nos.** field, the value **ITEM** is already filled in. Select on the Look Up Value button and select **+ New**.
   ...
   5. Select on the Lookup again and Select on View Details. Select the ellipses (…) and then select **Lines**.
...
### Steps
1. Create a location.
   1. Select the Search icon in the top-right corner of the page, enter Locations, and then choose the related link.
...
2. Set up an Inventory Posting Setup.
   1. Select the Search icon in the top-right corner of the page, enter Inventory Posting Groups, and then choose the related link.
...
Create a new account if you do not find it from the list.

1. Close the **Inventory Posting Setup Card**.
  2. Select the Search icon in the top-right corner of the page, enter General Posting Setup, and then choose the related link.
  3. In the **General Posting Setup** page, for each combination where the **Gen. Prod. Posting Group** field contains the value **COMPUTERHW**, make sure the following fields are filled in:
...
1. Set up Item Categories and Item Attributes.
   1. Select the Search icon in the top-right corner of the page, enter Item Categories, and then choose the related link.
   ...
   3. In the opened **Item Category Card** page, fill in the following fields:
      ...
      3. In the **Attributes** section, enter a new line, filling in the following fields:
         1. In the **Attribute** field, select on the Look Up Value button and select **Select from full list**.
         2. In the opened **Item Attributes** page, select +New the **Color** attribute, the field Type – Option.
         3. Select on the **Values** of **Color**.
            1. In the opened **Item Attributes Values** page, select **+ New**.
   ...
   5. In the opened **Item Category Card** page, fill in the following fields:
      ...
      4. In the **Attributes** section, enter a new line, filling in the following fields:
         1. In the **Attribute** field, select on the Look Up Value button and select **+ New**.
...
2. Create an Item template.
   1. Select the Search icon in the top-right corner of the page, enter Item Templates, and then choose the related link.
...
4. Create and configure a new item.
   ...
   6. On the **Item Attribute** FactBox in the right side, select **Edit**.
      1. For the attribute **Color**, select +New the value **Black**.
   ...
   42. On the **Item Attribute** FactBox, select **Edit**.
       1. For the attribute **Color**, select +New thethe value **White**.
       2. Select **OK** to close the FactBox.
