---
lab:
  title: 'Lab 20: Process Sales'
  module: 'Create sales documents in Dynamics 365 Business Central'
  duration: 90 minutes
  level: 300
  islab: true
---

## Exercise 20: Process Sales
...
On February 16th, 2026, a quote is created by Benjamin Chiu for the following items:
...
On February 22nd, 2026, Francematic accepts the sales quote and the quote is turned into an order.

The items are shipped to the customer on 2 different dates:

* On February 27th, 2026, the 15” flat panels are delivered.
* On February 28th, 2026, the 17” monitors are delivered.

On March 1st, 2026, the sales invoice is created and send to the customer.
...
Select the Search icon in the top-right corner of the page, enter Customer Templates, and then choose the related link.

Edit the CUSTOMER EU COMPANY line and choose Dimensions, select Dimension Code – CUSTOMERGROUP, Dimension Value Code – MEDIUM, Value Posting – Same Code.

1. Create a sales quote for a contact.
   ...
   4. Select the **CUSTOMER EU COMPANY** template and select **OK**.
   5. A new sales quote is created.
   6. In the **General** FastTab, select **Show more** and then fill in the following fields:
      1. In the **Order Date** and **Document Date** field, enter **2/15/2026**.
      2. In the **Quote Valid To Date** field, enter **2/25/2026**.
      3. In the **Salesperson Code** field, enter JR.
   7. On the **Lines** section, enter a new line by filling in the following fields:
      ...
      6. In the **Unit Price Excl. Tax/VAT** field, enter **4,800.00**.
   ...
   8. On the **Lines** section, enter a new line by filling in the following fields:
      ...
      6. In the **Unit Price Excl. Tax/VAT** field, enter **700.00**.
      7. In the **Line Discount %** field, enter **6**.
      8. In the **Tax Group Code**, enter **NONTAXABLE**.
2. Process the quote into an order.
   1. On the **Sales Quote** card page, change the **Order Date** field to **2/22/2026**.
...
1. Select **Yes** to open the sales order.

1. Partially ship items from the order.
   1. On the **Sales Order** card page, on the **General** FastTab, in the **Posting Date** field, enter **2/27/2026**.
   ...
   6. Select **OK**.
   7. On the **General** FastTab, in the **Posting Date** field, enter **2/28/2026**.
   8. Select **Home** and then select **Post**.
   9. Select the **Ship** option and select **OK**.
   10. Select **OK**.
2. Create a posted sales invoice from the sales order.
   1. On the **Sales Order** card page, on the **General** FastTab, in the **Posting Date** field, enter **3/1/2026**.
   2. Select **Home** and then select **Post**.
   3. Select the **Invoice** option and select **OK**.
   4. Select **No**.
3. Review the posted sales invoice.
...
| --- | --- | --- | --- | --- |
| 1/5/2026 | Private sale DK | PICK-UP-DK | 2 PCS | CHW1002 |
| 1/6/2026 | Private sale BE | PICK-UP-BE | 1 BOX | CHW1002 |
| 1/9/2026 | Private sale FR | PICK-UP-FR | 5 PCS | CHW1003 |

At the end of March 2026, 1 combined invoice is created for all private sales. You must now create this sales invoice for the Generic EU web shop customers, containing all shipments of January, including the 5% web shop discount for the month January.
...
1. Create several sales orders and shipments.
   ...
   4. On the opened **Sales Order** card page, on the **General** FastTab, select **Show more** and then fill in the following fields:
      1. In the **Order Date** field, enter **1/5/2026**.
   ...
   5. On the **Shipping and Billing** FastTab,select **Show more** and then fill in the following fields:
      ...
      2. On the opened **Ship-to Address** List page, select PICK-UP-DK and select **OK**.
   ...
   13. On the opened **Sales Order** card page, on the **General** FastTab, select **Show more** and then fill in the following fields:
       1. In the **Order Date** field, enter **1/6/2026**.
       2. In the **Posting Date** field, enter **3/7/2026**.
       3. In the **Your Reference** field, enter **Private sale BE**.
   14. On the **Shipping and Billing** FastTab, fill in the following fields:
       1. In the **Ship-to** field, select the **Alternate Shipping Address** option.
       2. On the opened **Ship-to Address** List page, select PICK-UP-BE and select **OK**.
       3. Select the **Combine Shipments** checkbox.
   ...
   22. On the opened **Sales Order** card page, on the **General** FastTab, select **Show more** and then fill in the following fields:
       1. In the **Order Date** field, enter **1/9/2026**.
       2. In the **Posting Date** field, enter **3/8/2026**.
       3. In the **Your Reference** field, enter **Private sale FR**.
   23. On the **Shipping and Billing** FastTab, fill in the following fields:
       1. In the **Ship-to** field, select the **Alternate Shipping Address** option.
       2. On the opened **Ship-to Address** List page, select **PICK-UP-FR** and select **OK**.
       3. Select the **Combine Shipments** checkbox.
...
2. Use the Combine Shipments function to create sales invoices.
   1. Select the search for page icon in the top-right corner of the page, enter **Combine Sales Shipments**, and then choose the related link.
   2. Open the **Combine Sales Shipments** task.
   3. In the **Posting Date** and **Document Date** field, enter **3/8/2026**.
...
You need to make a sales credit memo on March 6th, 2026, to refund 1 piece of this item.
...
1. Correct a posted sales invoice
   ...
   4. On the opened sales credit memo, on the **General** FastTab, select **Show more** and then enter **3/6/2026** in the **Posting Date** field.
