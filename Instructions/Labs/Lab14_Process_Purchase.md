...
lab:
  ...
  description: 'As the purchasing agent you are replenishing the stock for the European warehouse. '
  duration: 30 minutes
  level: 300
  islab: true
---
...
1.  Change the currency code on the vendor.
    ...
    4.  On the opened vendor card, go to the **Invoicing** FastTab, and select
        **Show more**.
...
4.  Create a posted purchase invoice from the purchase order.
    ...
    4.  On the **Lines** section, select the line for item **CHW1002**, and
        select on the **Settings** icon in the top-right corner.

    5.  Select **Personalize** to add the **Line Discount%** field.

    6.  Select **More** on the **Personalizing** ribbon.

    7.  Select the **Lines** area and select **+ Field** in the **Personalizing**
        ribbon.
...
2.  Ship the items.
    ...
    1.  On the **General** FastTab, select **Show more** and then fill in the
        following fields:
...
currently low on stock and a purchase order
with their main vendor Robert Townes is placed on January 1st, 2023. It was
agreed to always invoice in USD instead of their currency (DKK) and a purchase
request is sent to the correct order address for the following items to be
delivered on January 5th, 2023:
